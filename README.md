...
I've got a favorite Python design pattern but it now seems to have been lost in the mists of time, a Command Dispatch pattern.  Guido van Rossum described the pattern in a Python mailing list in 1997. Amazingly, I can't find that mailing list archived anywhere.  You would hope that every word that Guido ever wrote about Python would be archived somewhere! There's a pointer to it here but the link no longer exists:
  https://legacy.python.org/workshops/1997-10/proceedings/savikko.html
Look for "Guido van Rossum's Command Dispatch pattern".
